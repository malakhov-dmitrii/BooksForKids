...
<div>
    ...
    >
        {btnText}
        <div className={`${styles.check_filter_wrapper} ${open ? styles.check_filter_wrapper_active : ''}`}>
            <div className={`${styles.check_filter_flag} ${open ? styles.check_filter_flag_active : ''}`}></div>
        </div>
    </button> 
</div>
)
