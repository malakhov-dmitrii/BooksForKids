...
const CardLabel = ({ isNew, isBestSeller, isDiscount, inStock }: IAmCardLabelProps) => {
    const { lang, translations } = useLang()

    const outOfStockLabel = (
        <span
        className={`${styles.list_item_label} ${styles.list_item_instock}`}
        >
    ...
    const newLabel = (
        <span
        className={`${styles.list_item_label} ${styles.list_item_isnew}`}
        >
