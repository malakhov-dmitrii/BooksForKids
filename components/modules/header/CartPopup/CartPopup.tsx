            ...
            <div className="cart_popup" ref={ref}>
                ...
                >
                    ...
                    <span className='not_empty'>
                        <span className='not_empty_count'>{countWholeCartItemsAmount(currentCartByAuth)}</span>
                    </span>
                    }
                </Link>
                {open && (
                    ...
                    >
                        ...
                        <button className="cart_popup_close"
                        onClick={handleHidePopup}
                        />
                        <h5 className="cart_popup_title">{translations[lang].other.shopping_cart}</h5>
                        ...
                        <div className="cart_popup_footer">
                            ...
                            <h5>{translations[lang].other.subtotal} (<ItemsCount
                            count={countWholeCartItemsAmount(currentCartByAuth)}
                            />)
                            </h5>
                            </div>
                            ...
                            :
                            <Link href='/cart' className='cart_popup_footer_link body_large black_btn'>
