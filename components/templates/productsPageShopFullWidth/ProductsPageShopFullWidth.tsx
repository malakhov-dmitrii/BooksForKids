...
const ProductsPageShopFullWidth = ({ searchParams, pageName }: IAmProductsPage) => {
  ...
  } = useProductFiltersFullWidth(searchParams, pageName, pageName === 'catalog/shop_full_width')
